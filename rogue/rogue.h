...
/*
 *	Sigh - ncurses.h defines CURSES - add one to the bogometer
 *
 */

#ifdef NCURSES_VERSION		/* If its Ncurses adding tons of bogoid defines */
#undef CURSES			/* Get it out of our define space */
#endif				/* lose lose lose */
