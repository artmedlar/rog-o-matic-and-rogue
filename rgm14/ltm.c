...
void restoreltm (void)
{
  // // fprintf(stderr, "DEBUG restoreltm: version=%d, RGMDIR=%s\n", version, RGMDIR);
  fflush(stderr);
  sprintf (ltmnam, "%s/ltm%d", RGMDIR, version);
  // // fprintf(stderr, "DEBUG restoreltm: ltmnam=%s\n", ltmnam);
  fflush(stderr);
  // // fprintf(stderr, "DEBUG restoreltm: calling dwait\n"); fflush(stderr);
  dwait (D_CONTROL, "Restoreltm called, reading file '%s'", ltmnam);
  // // fprintf(stderr, "DEBUG restoreltm: dwait done\n"); fflush(stderr);

  // // fprintf(stderr, "DEBUG restoreltm: calling clearltm, monhist=%p\n", (void*)monhist); fflush(stderr);
  clearltm (monhist);			/* Clear the original sums */
  // // fprintf(stderr, "DEBUG restoreltm: clearltm done\n"); fflush(stderr);
