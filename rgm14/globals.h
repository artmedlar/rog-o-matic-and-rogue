...
int dwait(int msgtype, const char *f, ...);

/* double precision floating point functions */
double prob(), mean(), stdev();	/* For stats.c */

/* Debug tracing - enable with -D flag */
extern int debug_trace;		/* True if debug tracing enabled */
extern FILE *debug_file;	/* Debug output file */
extern int moverate;		/* Max moves per second (0 = unlimited) */
